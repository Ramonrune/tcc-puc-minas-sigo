...
public class S3 {
	...
	public void save(MultipartFile arquivo, String codigo) {
		...
		try {
			PutObjectRequest putObjectRequest = new PutObjectRequest("sigo-standards", nomeUnico,
	...
	public InputStream get(String codigo) {
		...
		S3Object object = client.getObject(new GetObjectRequest("sigo-standards", codigo + ".pdf"));
		
		return object.getObjectContent();
	}

	public void remove(String codigo) {
		DeleteObjectRequest deleteObjectRequest = new DeleteObjectRequest("sigo-standards", codigo + ".pdf");
